...
public class SQLRequest_Insert {
	private final static String INSERT_CLIENT_PHYSIQUE = "insert into client(id_client, typeClient,prenom ,nom,numeroTel,numeroFax,email,adresse,cp,ville,pays, titre) values(nextval('seq_client'),'P',?,?,?,?,?,?,?,?,?,?)";
	private final static String INSERT_CLIENT_MORAL = "insert into client(id_client,typeClient,nom,numeroTel,numeroFax,email,adresse,cp,ville,pays, siret, titre) values(nextval('seq_client'),'M',?,?,?,?,?,?,?,?,?,?)";
	private final static String INSERT_CLIENT_El = "insert into client(id_client,typeClient,prenom ,nom,numeroTel,numeroFax,email,adresse,cp,ville,pays, titre) values(nextval('seq_client'),'E',?,?,?,?,?,?,?,?,?,?)";
	...
	// INSERER UN LOGIN
	public Long insertLogin(Context ctx, String login, String motDePasse, Boolean admin) {
		PreparedStatement ps = null;
		Statement st = null;
		Long numeroGenere = (long) -1;
		ResultSet rs = null;
	...
	// INSERER UN VOL
	public Long insertVol(Context ctx, Date date_Depart, Date date_Arrivee, Date heure_Depart, Date heure_Arrivee) {
		PreparedStatement ps = null;
		Statement st = null;
		Long numeroGenere = (long) -1;
		ResultSet rs = null;
	...
	public Long insertReservation(Context ctx, Date date, Long numero) {
		PreparedStatement ps = null;
		Statement st = null;
		Long numeroGenere = (long) -1;
		ResultSet rs = null;
